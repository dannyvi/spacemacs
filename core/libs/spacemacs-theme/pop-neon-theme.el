;;; pop-neon-theme.el --- neon on the Dark theme with a deep background

;; Copyright (C) 2016 DannyV

;; Author: DannyV <dannyvis@icloud.com>
;; Keywords: themes
;; Package-Version: 20160420.1
;; URL: http://github.com/dandany/emacs-pop-neon-theme
;; Version: 0.1
...
(deftheme pop-neon
  "pop neon on the dark color theme with a deep  background")
...
(let* ((class '((class color) (min-colors 89)))
       ...
       ;;;(selection "#aa2240")
       (selection "#303030")
       (foreground (if 256color "#aaaaaa" "#7a7b88"))
       (comment (if 256color "#585858" "#343750"))
       (red "#aa0033")
       ;;;(orange "goldenrod")
       (orange "#ffcc00")
       (yellow "#ffff88")
  ...
  (custom-theme-set-faces
   ...
   `(bold-italic ((,class (:slant italic :weight normal))))
...
;;;   `(python-font-lock-keywords ((,class (:foreground ,red))))
   ...
   ;; Rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:foreground "#1144aa"))))
   `(rainbow-delimiters-depth-2-face ((,class (:foreground "#6600ff"))))
   `(rainbow-delimiters-depth-3-face ((,class (:foreground "#226644"))))
   `(rainbow-delimiters-depth-4-face ((,class (:foreground "#aa0044"))))
   `(rainbow-delimiters-depth-5-face ((,class (:foreground "#22aa88"))))
   `(rainbow-delimiters-depth-6-face ((,class (:foreground "#aa77ff"))))
   `(rainbow-delimiters-depth-7-face ((,class (:foreground "#66ccff"))))
   `(rainbow-delimiters-depth-8-face ((,class (:foreground "#88ffaa"))))
   `(rainbow-delimiters-depth-9-face ((,class (:foreground "#ffaa44"))))
   `(rainbow-delimiters-unmatched-face ((,class (:foreground "#ff88aa"))))
   ...
   `(linum ((,class (:background ,current-line :foreground ,li-no))))
   ...
   `(org-hide ((,class (:foreground ,background :background ,selection))))
   ...
   `(highlight-symbol-face ((,class (:background ,orange :foreground ,background))))
   `(highlight-80+ ((,class (:background ,current-line))))

   ;; Python-specific overrides
  ;;; `(py-builtins-face ((,class (:foreground ,aqua :weight normal))))
   `(py-number-face ((,class (:foreground ,yellow))))
   `(py-decorators-face ((,class (:foreground ,aqua))))
   ...
   `(term-color-white   ((,class (:foreground ,background :background ,selection)))))
